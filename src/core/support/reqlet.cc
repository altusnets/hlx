...
reqlet::reqlet(const reqlet &a_reqlet):
        ...
        m_headers(a_reqlet.m_headers),
        m_next_value(a_reqlet.m_next_value),
        m_body(a_reqlet.m_body),
        m_status(a_reqlet.m_status),
...
//: ----------------------------------------------------------------------------
#if 0
void reqlet::set_uri(const std::string &a_uri)
{
        m_uri = a_uri;
...
//: ----------------------------------------------------------------------------
#if 0
void reqlet::set_header(const std::string &a_key, const std::string &a_val)
{
...
//: ----------------------------------------------------------------------------
#if 0
void reqlet::set_body(const std::string &a_body)
{
        m_body = a_body;
}
#endif
...
//: ----------------------------------------------------------------------------
#if 0
const kv_list_map_t &reqlet::get_uri_decoded_query(void)
{
