...
//: \param:   TODO
//: ----------------------------------------------------------------------------
int hlx_server::hp_on_message_begin(http_parser* a_parser)
{
#if 0
        hlx_server *l_hlx_server = static_cast <hlx_server *>(a_parser->data);
        if(l_hlx_server)
        {
                if(l_hlx_server->m_verbose)
                {
...
//: \param:   TODO
//: ----------------------------------------------------------------------------
int hlx_server::hp_on_url(http_parser* a_parser, const char *a_at, size_t a_length)
{
        hlx_server *l_hlx_server = static_cast <hlx_server *>(a_parser->data);
        if(l_hlx_server)
        {
                ...
                l_hlx_server->m_request.set_uri(l_url);
...
//: \param:   TODO
//: ----------------------------------------------------------------------------
int hlx_server::hp_on_header_field(http_parser* a_parser, const char *a_at, size_t a_length)
{
        hlx_server *l_hlx_server = static_cast <hlx_server *>(a_parser->data);
        if(l_hlx_server)
        {
                ...
                l_hlx_server->m_next_header.assign(a_at, a_length);
        }
...
//: \param:   TODO
//: ----------------------------------------------------------------------------
int hlx_server::hp_on_header_value(http_parser* a_parser, const char *a_at, size_t a_length)
{
        hlx_server *l_hlx_server = static_cast <hlx_server *>(a_parser->data);
        if(l_hlx_server)
        {
                ...
                l_hlx_server->m_request.set_header(l_hlx_server->m_next_header, l_val);
...
//: \param:   TODO
//: ----------------------------------------------------------------------------
int hlx_server::hp_on_headers_complete(http_parser* a_parser)
{
        hlx_server *l_hlx_server = static_cast <hlx_server *>(a_parser->data);
        if(l_hlx_server)
        {
...
//: \param:   TODO
//: ----------------------------------------------------------------------------
int hlx_server::hp_on_body(http_parser* a_parser, const char *a_at, size_t a_length)
{
        hlx_server *l_hlx_server = static_cast <hlx_server *>(a_parser->data);
        if(l_hlx_server)
        {
                ...
                l_hlx_server->m_body.append(a_at, a_length);
...
//: \param:   TODO
//: ----------------------------------------------------------------------------
int hlx_server::hp_on_message_complete(http_parser* a_parser)
{
        hlx_server *l_hlx_server = static_cast <hlx_server *>(a_parser->data);
        if(l_hlx_server)
        {
                ...
                // we outtie
                l_hlx_server->m_request.set_body(l_hlx_server->m_body);
                l_hlx_server->m_cur_msg_complete = true;
        }
...
void *hlx_server::t_run(void *a_nothing)
{
